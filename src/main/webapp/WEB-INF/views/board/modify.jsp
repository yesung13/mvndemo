			...
			<form id="form">
				...
				<table class="table table-bordered">
					<tr class="thead-light">
						...
						<td>
							<input type="text" id="title" name="title" class="form-control" placeholder="40자 이내  작성하세요" value="${boardListDetail.title}" />
						</td>
					</tr>
					<tr class="thead-light">
						<th class="tcenter">
						...
						<td>
							<textarea id="content" name="content" rows="8" class="form-control w-100 mb-1" onkeyup="fnCheckByte(this)" placeholder="내용을 입력하세요...">${boardListDetail.content}</textarea>

							<div class="d-inline ">
								<span id="byteInfo" class="font-weight-bold">0</span>
								&nbsp;
								<span class="font-weight-bold">bytes</span>
								&nbsp;&nbsp;
				...
				<div class="row justify-content-center">
					...
					<button type="button" data-oper="modify" class="btn btn-outline-secondary mx-1" id="modify_btn">수정</button>
